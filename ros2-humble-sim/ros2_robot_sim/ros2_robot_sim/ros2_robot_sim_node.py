...
class SimNode(Node):
    def __init__(self):
        ...
        self.image_map = cv2.imread("/home/cogniteam-user/advantech_patrol_ws/src/ros2-humble-sim/ros2_robot_sim/resource/map/map.pgm",0)
        self.image_map = cv2.flip(self.image_map, 0)

        self.map_info_dict = self.load_map_yaml("/home/cogniteam-user/advantech_patrol_ws/src/ros2-humble-sim/ros2_robot_sim/resource/map/map.yaml")
